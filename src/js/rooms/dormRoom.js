...
export class dormRoom extends room {
    ...
    onActivate() {
        ...
        this.Spirit = new spirit(this.Sjaak, 1150, 530,this.game,true)
        this.add(this.Spirit)
        this.Spirit2 = new spirit(this.Sjaak, 1150, 600,this.game,true)
        this.add(this.Spirit2)

        this.Ghoul = new ghoul(this.Sjaak, 1100, 230, 4,this.game,true)
        this.add(this.Ghoul)
    }
}